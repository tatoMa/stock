                    ...
                    <v-card-title primary-title>
                        <v-flex>
                            ...
                            <div>
                                ...
                                <v-btn block color="primary" @click="maxProfitCalculator">Calculate</v-btn>
                                <h4 class="text-xs-center" v-if="maxProfit!==''">The max profit of {{identifierSelected}} is {{maxProfit}}</h4>
                                <br/>
                            </div>
                        </v-flex>
                    </v-card-title>
